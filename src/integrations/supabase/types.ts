  ...
  public: {
    Tables: {
      ...
      route_places: {
        Row: {
          ...
          route_id: string
          transport_to_next:
            | Database["public"]["Enums"]["route_transport"]
            | null
        }
        Insert: {
          estimated_time?: number | null
      ...
      routes: {
        Row: {
          ...
          description: string | null
          difficulty_level:
            | Database["public"]["Enums"]["route_difficulty"]
            | null
          ...
          transport_mode: Database["public"]["Enums"]["route_transport"] | null
          updated_at: string
        }
        Insert: {
          created_at?: string
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "routes_family_id_fkey"
            columns: ["family_id"]
            isOneToOne: false
            referencedRelation: "family_groups"
            referencedColumns: ["id"]
    ...
    Functions: {
      ...
      _postgis_selectivity: {
        Args: { tbl: unknown; mode?: string; geom: unknown; att_name: string }
        Returns: number
      }
      _st_3dintersects: {
      ...
      get_route_waypoints: {
        ...
        Returns: {
          ...
          place_rating: number
          place_location_name: string
          latitude: number
          longitude: number
          order_index: number
          transport_to_next: Database["public"]["Enums"]["route_transport"]
          estimated_time: number
          notes: string
        }[]
      }
      get_routes_with_details: {
        Args: Record<PropertyKey, never>
        Returns: {
          name: string
          description: string
          ...
          difficulty_level: Database["public"]["Enums"]["route_difficulty"]
          transport_mode: Database["public"]["Enums"]["route_transport"]
      ...
      is_family_admin: {
        Args: { family_group_id: string; check_user_id: string }
        Returns: boolean
      }
      is_family_member: {
        Args: { family_group_id: string; check_user_id: string }
    ...
    Enums: {
      ...
      place_category:
        ...
        | "restaurants"
        | "accommodation"
      route_difficulty: "easy" | "moderate" | "hard"
      route_transport:
        | "walking"
        | "driving"
        | "cycling"
